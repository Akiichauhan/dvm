...
// isme muje relogin krna padega tab pataa chalegaa
//
  @override
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            // yahaa pe jo static dataa aata he
                                            // muje dynamic dataa chahiye
                                            Padding(
...
*/
            print(snapshot.data);
            // return Text(
            //   snapshot.data!.data!.liveIn.toString(),
            //   style: const TextStyle(color: Colors.red, fontSize: 42.0),
            // );
            return Text(
              snapshot.data!.data!.village.toString(),
              style: const TextStyle(color: Colors.red, fontSize: 42.0),
            );
          } else {
            ...
            // bro 70 pe eror he
            return const Text("This is Akash");
          }
          // bro aap ye if else ko pura kro fir hi kuch ptaa chal skta he  run krn isy
        },
      ),
    );
  }
